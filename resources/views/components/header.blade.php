                ...
                <nav class="navbar {{ $showMenu ? '' : 'justify-content-center' }} navbar-expand-lg navbar-light">
                    <a class="navbar-brand" href="{{ route('welcome') }}">
                        <span style="color: #FFCA4C;">
                            <img src="{{ asset('img/logo_no_bg.png') }}" alt="YoungBotMinds"
                    ...
                    @if ($showMenu)
                        ...
                        <button class="navbar-toggler d-lg-none" type="button"
                            aria-label="{{ __('other.open_navigation') }}" id="customBurger">
                        ...
                        <div class="collapse navbar-collapse justify-content-end d-none d-lg-flex" id="mainNavbar">
                            <ul class="navbar-nav mb-2 mb-lg-0 align-items-lg-center" style="gap: 0.5rem;">
                                <li class="nav-item active">
                                    <a class="nav-link" href="#home">{{ __('other.home') }}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#about">{{ __('other.about') }}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#features">{{ __('other.features') }}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#stats">{{ __('other.our_impact') }}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#contact">{{ __('other.contact') }}</a>
                                </li>
                                <li class="nav-item ms-lg-3">
                                    <a class="btn_1"
                                        href="{{ route('registration.form') }}">{{ __('other.join_now') }}</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div id="mobileFullMenu" class="mobile-fullpage-menu-overlay d-lg-none">
                            <div class="mobile-fullpage-menu-content">
                                <button type="button" class="close-mobile-fullpage-menu" id="closeMobileFullMenu"
                                    aria-label="{{ __('other.close_menu') }}">
                                    &times;
                                </button>
                                <ul class="navbar-nav flex-column align-items-center justify-content-center"
                                    style="gap: 2rem; font-size: 2rem;">
                                    <li class="nav-item active">
                                        <a class="nav-link" href="#home">{{ __('other.home') }}</a>
                                    </li>
                                    <li class="nav-item">
