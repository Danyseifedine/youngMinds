...
<section id="stats" class="stats_section"
    style="padding: 100px 0; background: linear-gradient(135deg, #0c2e60 0%, #1a4a8a 100%); position: relative; overflow: hidden; margin-bottom: 80px;">
    ...
    <div class="container" style="position: relative; z-index: 2;">
        ...
        <div class="row g-5">
            <!-- Stats Card 1 -->
            <div class="col-lg-4 col-md-6 col-sm-12 mb-4" data-aos="zoom-in" data-aos-delay="100">
                <div class="stats_card"
                    style="background: rgba(255, 255, 255, 0.1); backdrop-filter: blur(10px); border: 1px solid rgba(255, 255, 255, 0.2); border-radius: 20px; padding: 40px 30px; text-align: center; transition: all 0.4s ease; position: relative; overflow: hidden; height: 100%; margin-bottom: 20px;"
                    ...
                    <div class="stats_icon"
                        style="width: 80px; height: 80px; background: linear-gradient(135deg, #FFCA4C, #FFD700); border-radius: 20px; display: flex; align-items: center; justify-content: center; margin: 0 auto 25px; position: relative; overflow: hidden;">
                        <i class="fas fa-user-graduate"
                            style="font-size: 32px; color: white; z-index: 2; position: relative;"></i>
                    </div>
            ...
            <!-- Stats Card 3 -->
            <div class="col-lg-4 col-md-6 col-sm-12 mb-4" data-aos="zoom-in" data-aos-delay="300">
                <div class="stats_card"
                    style="background: rgba(255, 255, 255, 0.1); backdrop-filter: blur(10px); border: 1px solid rgba(255, 255, 255, 0.2); border-radius: 20px; padding: 40px 30px; text-align: center; transition: all 0.4s ease; position: relative; overflow: hidden; height: 100%; margin-bottom: 20px;"
                    onmouseover="this.style.transform='translateY(-10px)'; this.style.background='rgba(255, 255, 255, 0.15)'"
                    onmouseout="this.style.transform='translateY(0)'; this.style.background='rgba(255, 255, 255, 0.1)'">
